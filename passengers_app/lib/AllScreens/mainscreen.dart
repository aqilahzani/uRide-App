...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin
{
        ...
        child: Drawer(
          child: ListView(
            children: [
              ...
              //History Drawer Body Controllers
              GestureDetector(
                onTap: ()
                {
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null) ? '\RM${(AssistantMethods.calculateFares(tripDirectionDetails))*2}' : ''), style: TextStyle(fontFamily: "Brand Bold",),
                                ),
                              ],
                            ),
                          ),
  ...
  void initGeoFireListner() {
    ...
    //available driver within 15km radius
  ...
  void notifyDriver(NearbyAvailableDrivers driver)
  {
    ...
    //retrieve driver token from database
