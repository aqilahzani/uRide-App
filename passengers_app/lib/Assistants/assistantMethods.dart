...
class AssistantMethods {
  ...
  static Future<String> searchCoordinateAddress(Position position, context) async {
    ...
    String url = "https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude}"
        ",${position.longitude}&key=AIzaSyBSeox9GKDoDcWDdPbi7OOwJDSedCvye1g";
  ...
  {
    String directionUrl = "https://maps.googleapis.com/maps/api/directions/json?origin=${initialPosition.latitude},"
        "${initialPosition.longitude}&destination=${finalPosition.latitude},${finalPosition.longitude}&key=$mapKey";
  ...
  static int calculateFares(DirectionDetails directionDetails)
  {
    ...
    double distancTraveledFare = (directionDetails.distanceValue / 1000) * 0.23;
    //double totalFareAmount = (timeTraveledFare + distancTraveledFare)+5;
    double totalFareAmount = distancTraveledFare + 5;
