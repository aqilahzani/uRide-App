      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("\RM$fareAmount", style: TextStyle(fontSize: 55.0, fontFamily: "Brand Bold"),),

            SizedBox(height: 16.0,),SizedBox(height: 16.0,),

            Padding(
              padding: EdgeInsets.symmetric(horizontal: 20.0),
              child: Text("This is the total trip amount, it has been charged to the passenger.", textAlign: TextAlign.center,),
            ),
