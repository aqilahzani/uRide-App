      ...
      children: [
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text("\RM${Provider.of<AppData>(context, listen: false).earnings}", style: TextStyle(color: Colors.white, fontSize: 50, fontFamily: 'Brand Bold'),)
              ],
            ),
          ),
        ),
        ...
        TextButton(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Image.asset('images/car.png', width: 70,),
                SizedBox(width: 16,),
