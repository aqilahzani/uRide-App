                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: ()
                        {
                          ...
                          {
                            displayToastMessage("Please insert Car Model.", context);
                          }
                          else if(carNumberTextEditingController.text.isEmpty)
                          {
                            displayToastMessage("Please insert Car Number.", context);
                          }
                          else if(carColorTextEditingController.text.isEmpty)
                          {
                            displayToastMessage("Please insert Car Color.", context);
                          }
                          else
                          {
